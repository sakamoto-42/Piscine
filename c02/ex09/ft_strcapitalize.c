...
/*   Updated: 2024/04/08 14:01:35 by sakamoto-42      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strcapitalize(char *str)
{
	...
	{
		if (str[i] >= 'a' && str[i] <= 'z')
			ft_handle_char_lowercase(&str[i], &is_first_letter);
		else if (str[i] >= 'A' && str[i] <= 'Z')
			ft_handle_char_uppercase(&str[i], &is_first_letter);
		else if (str[i] >= '0' && str[i] <= '9')
			ft_handle_char_numeric(&is_first_letter);
		else
			ft_handle_char_non_alphanumeric(&is_first_letter);
		i++;
	}
	return (str);
}
